...
export const tools: Tool[] = [
  ...
  { slug: 'compress-jpg', title: 'Compress JPG', description: 'JPEG-specific compression with quality slider. Smallest possible file size.', icon: '🖼️', category: 'compress', available: true },
  { slug: 'compress-png', title: 'Compress PNG', description: 'Lossless PNG compression. Reduce file size while keeping every pixel.', icon: '🖼️', category: 'compress', available: true },
  { slug: 'image-compressor-batch', title: 'Batch Compress', description: 'Compress dozens of images at once. Drag, drop, download zip.', icon: '📦', category: 'optimize', available: true },
