...
export const tools: Tool[] = [
  ...
  { slug: 'crop-image', title: 'Crop Image', description: 'Crop images to exact dimensions or aspect ratios. Preview before saving.', icon: '✂️', category: 'edit', available: false },
  { slug: 'rotate-image', title: 'Rotate Image', description: 'Rotate images 90°, 180°, 270° or by custom angle. Lossless rotation.', icon: '🔃', category: 'edit', available: false },
  ...
  { slug: 'image-watermark', title: 'Add Watermark', description: 'Add text or logo watermark to images. Single or batch.', icon: '💧', category: 'edit', available: false },
